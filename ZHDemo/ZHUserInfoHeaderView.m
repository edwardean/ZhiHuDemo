...
- (void)bindHeaderContentWithObject:(id<ZHObject>)object
{
    ...
    if (infoObject.avatar_url) {
        ...
        [manager downloadWithURL:[NSURL URLWithString:infoObject.avatar_url] options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize) {
