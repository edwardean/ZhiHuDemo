...
- (void)bindHeaderContentWithObject:(id<ZHObject>)object
{
    ...
    if (answerHeaderObject.avatarURL) {
        ...
        [manager downloadWithURL:[NSURL URLWithString:answerHeaderObject.avatarURL] options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize) {
